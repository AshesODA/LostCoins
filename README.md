...
## Quick start
- Сonvert addresses into binary hashes RIPEMD160 use [b58dec.exe] Сommand: ```b58dec.exe addresses.txt base160.bin```
- It is important to sort the base160.bin file otherwise the Bloom search filter will not work as expected.
- To sort base160.bin use the program [RMD160-Sort.exe] Сommand: ```RMD160-Sort.exe base160.bin hex160-Sort.bin``` 
